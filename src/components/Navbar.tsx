  ...
  return (
    <div className="w-full mb-5 px-5 py-3 border-b-[#eeeef61c] border-b-1 flex justify-between">
      ...
      <div className="flex items-center gap-1">
        ...
        <button className="bg-[#e8e8fd0d] hover:bg-[#0E9577] transition-colors duration-1500 ease-in-out rounded-md backdrop-blur-md cursor-pointer px-6 py-2 flex gap-1 items-center"><CiLogout />Logout</button>
      </div>
    </div>
  )
}